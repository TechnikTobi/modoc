...
# ToDos:
########
# Temperaturwerte 0C und 400C automatisch als ungültig erkennen und bei Graphen ausblenden
...
class GraphenLinie:
    ...
    def updateAnzeige(self):
        ...
        if (self.meinMessobjekt.MesswertEinheit == "°C") & (self.meinMessobjekt.value == 0):
            self.data = np.array([])
...
class App:
    def __init__(self, eingabeRoot, eingabeCanvas, eingabeUserName):
        ...
        self.MesswertObjekte = {
            ...
            "Schub":        Messobjekt("Schub",                "SB",    "kg",       0,          3000,       0,          3000,       3000,       6,              34,             2,                  "#53b9ff",  "#448AFF",      self.Glättung,          self),
    ...
    def leseUSBline(self):
        ...
        if usbsim:
            ...
            if self.simrechteck2Null:
                ...
                self.simrechteck2 = random.randint(320, 340)
