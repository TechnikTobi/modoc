...
#                print ("letzter: " + str(RingbuffDrehmomentletzter) + "  ältester: " + str(RingbuffDrehmomentältester) + " Glätttiefe: " + str (i) + " Glätt: " + str (GlättDrehmoment))
                ...
                #    umspeichern Temp1..4
#                datag[ 5] = self.Tempmap(data[ 9])
                datag[ 5] = data[ 9]
                datag[ 6] = self.Tempmap(data[10])
                datag[ 7] = self.Tempmap(data[11])
                datag[ 8] = self.Tempmap(data[12])

                #    umspeichern Temp5..8
                datag[ 9] = self.Tempmap(data[42])
                datag[10] = self.Tempmap(data[43])
                datag[11] = self.Tempmap(data[44])
#                datag[12] = int((0.0000026066122037748*data[44]**3+0.0002554650952481*data[44]**2+1.0379113982268*data[44]-227.86262468827)*10)/10
                datag[12] = self.Tempmap(data[45])
